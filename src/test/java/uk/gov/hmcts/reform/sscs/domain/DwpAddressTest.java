...
public class DwpAddressTest {
    ...
    public void linesWith3LinesAndPostCode() {
        ...
        assertArrayEquals(MUST_BE_EQUAL, new String[] {LINE_1, LINE_2, LINE_3, POSTCODE}, address.lines());
    }

    @Test
    public void linesWith2LinesAndPostCode() {
        DwpAddress address = new DwpAddress(LINE_1, LINE_2, POSTCODE);
        assertArrayEquals(MUST_BE_EQUAL, new String[] {LINE_1, LINE_2, POSTCODE}, address.lines());
    }
    ...
    public void linesWith2LinesAndPostCodeWithOneLineBlank(final String line2) {
        ...
        assertArrayEquals(MUST_BE_EQUAL, new String[] {LINE_1, POSTCODE}, address.lines());
    }
